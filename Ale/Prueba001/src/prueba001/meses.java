...
// por lo que este archivo deber�a llamarse "SELECCIONADORDEMESES.java."
...
public class meses {
	...
	public static void imprimirmes(int numero_mes) {
		switch (numero_mes) {
		case 1:
	...
	public static void main(String args[]) throws IOException {
		...
		//int, float, double, char, boolean, string, byte
                int opcionseleccionada;
		do {
			System.out.println(""); // no hay forma directa de borrar la consola en Java
			pintarmenu();
			opcionseleccionada = Integer.getInteger(bufEntrada.readLine());
			// ESTO ES UN COMENTARIO
			imprimirmes(opcionseleccionada);

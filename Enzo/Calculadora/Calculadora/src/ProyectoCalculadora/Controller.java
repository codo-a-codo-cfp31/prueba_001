...
calculadora.setA((float) Double.parseDouble(elemento));
             ...
             if (tecla.equals("Ans")) {
  calculadora.setOp("Ans");
     String Operacion =calculadora.getResultString();
                main_view.getjTextField2().setText(Operacion);
                main_view.getjTextField1().setText("");
            }
             
             if (tecla.equals("(")) {
                main_view.getjTextField2().setText(main_view.getjTextField2().getText()+"(");
                main_view.getjTextField1().setText(main_view.getjTextField2().getText()+"(");
            }
       ...
       main_view.getjButton21().setText("tan");
        main_view.getjButton23().setText("ln");
          ...
          main_view.getjButton28().setText("inv");
            ...
            if (tecla.equals("=")) {
 if (calculadora.getOp().equalsIgnoreCase("+") || calculadora.getOp().equalsIgnoreCase("-") || calculadora.getOp().equalsIgnoreCase("x") || calculadora.getOp().equalsIgnoreCase("/")|| calculadora.getOp().equalsIgnoreCase("^")|| calculadora.getOp().equalsIgnoreCase("y√x")|| calculadora.getOp().equalsIgnoreCase("EXP")) {
                    String elemento = main_view.getjTextField1().getText();
